...
MACROS_LENGTH = {"PUSHL8": 1, "PUSHL16": 2, "PUSHL32": 4, "PUSHL64": 8}
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="frontend of nyulan_asm :convert nyulan assembly into nyulan middlecode", prog="frontend.py"
    )
